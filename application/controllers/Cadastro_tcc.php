...
/**
 * Description of Cadastro_tcc
 *
 * @author Andersonbk17
 */
class Cadastro_tcc extends CI_Controller{
        public function index() {
        
        $opcaoLateral ['opcaoLateral']= "tcc";
        $this->load->view('/tcc/cadastro');
    ...
    public function cadastrar(){
        ...
        $this->form_validation->set_rules('orientador', '[ORIENTADOR]', 'required|min_length[3]');
         ...
         if ($this->form_validation->run() == FALSE) {
           ...
           $this->load->view('/tcc/cadastro', $erros);
            ...
            $dados['orientador'] = $this->input->post('orientador');
            ...
            $dados['anexo'] = base_url() .'uploads/tcc/'.$dados['titulo'].'-'.$nomeAluno.'pdf';
        
            
            
            //SALVANDO
            $this->tcc->salvar($dados);
            ...
            $this->load->view('/tcc/cadastro',$mensagem);
            $this->load->view('includes/html_header');
            $this->load->view('includes/html_footer');
            $this->load->view('includes/menu',$opcaoLateral);
            $this->load->library('form_validation');
