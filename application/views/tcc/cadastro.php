...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_tcc/cadastrar" method="post" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados do TCC</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="orientador"  name="orientador" placeholder="Nome do Orientador" required="">
                  </div>
