...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_producao_artistico/cadastrar" method="post" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados da Produção Artística</h3>
              </div>
              <div class="panel-body">
                
                  <div class="form-group col-md-12">
                    <label for="titulo">Título *</label>
                    <input type="text" class="form-control" id="titulo"  name="titulo" placeholder="Título da produção artística">
                  </div>
