<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
        <h1 class="page-header">NOVO MANUAL DE ATIVIDADE PRÁTICA</h1>
    </div>
...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_manual_atividade/cadastrar" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados do Manual</h3>
              </div>
              <div class="panel-body">
                
                  <div class="form-group">
                    <label for="titulo">Título *</label>
                    <input type="text" class="form-control" id="titulo"  name="titulo"placeholder="Título Completo" required="">
                  </div>
                  <div class="form-group">
                    <label for="periodo">Período *</label>
                    <input type="text" class="form-control" id="periodo"  name="periodo" placeholder="Período de Elaboração" required="">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="descricao" name="descricao" placeholder="BREVE DESCRIÇÃO" rows="6" required=""></textarea>
                  </div>
                  <div class="form-group">
