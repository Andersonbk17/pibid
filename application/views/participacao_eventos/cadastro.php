<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
        <h1 class="page-header">NOVA PARTICIPAÇÃO EVENTOS</h1>
    </div>
...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_participacao_eventos/cadastrar" method="post" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados do Evento</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="form-group col-md-12">
                   ...
                   <div class="form-group col-md-12">
                    <label for="quantidade_bolsistas">Participantes *</label>
                    <input type="text" class="form-control" id="quantidade_bolsistas"  name="quantidade_bolsistas" placeholder="Quantidade de bolsistas que participaram do evento (VER COM EDINEI)" required="">
                  </div>
