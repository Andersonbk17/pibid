<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
        <h1 class="page-header">NOVA VISITA TÉCNICA</h1>
    </div>
...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_visita_tecnica/cadastrar" method="post" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados da Visita Técnica</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="form-group col-md-8">
                    ...
                    <input type="text" class="form-control" id="participantes"  name="participantes" placeholder="Quantidade de Participantes (VER COM EDNINEI)">
                  </div>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id="objetivo" name="objetivo" placeholder="BREVE DESCRIÇÃO" rows="6" required=""></textarea>
                  </div>
                  <div class="form-group col-md-12">
