<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
        <h1 class="page-header">NOVA MOSTRA FEIRAS</h1>
    </div>
...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_feira/cadastrar" method="post" method="post" enctype="multipart/form-data">
