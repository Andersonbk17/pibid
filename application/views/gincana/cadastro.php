<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="col-md-12">
        <h1 class="page-header">NOVA GINCANA</h1>
    </div>
...
?>
    ...
    <div class="col-md-12" >
        <form  id="form" action="<?php echo base_url(); ?>Cadastro_gincana/cadastrar" method="post" enctype="multipart/form-data">

            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Dados da Gincana</h3>
              </div>
              <div class="panel-body">
                
                  <div class="form-group col-md-12">
                    <label for="tema">TEMA *</label>
                    <input type="text" class="form-control" id="tema"  name="tema" placeholder="Título ou tema da Gincana" required="">
                  </div>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id="descricao" name="sintese" placeholder="BREVE SÍNTESE DA ATIVIDADE MÁXIMO 100 PALAVRAS" rows="6" required=""></textarea>
                  </div>
                  <div class="form-group col-md-12">
